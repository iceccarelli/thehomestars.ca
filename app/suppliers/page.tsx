...
import { SUPPLIERS } from "../_lib/data";
  ...
  return (
    <>
      <Container className="py-12 sm:py-16">
        <SectionHeading eyebrow="Integrated supply chain" title="Source materials from local suppliers" sub="Trade pricing and reliable delivery from suppliers vetted for quality and service across the GTA." />
