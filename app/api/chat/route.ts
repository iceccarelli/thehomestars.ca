      ...
      capture_job_lead: tool({
        ...
        execute: async (lead) => {
          ...
          try {
            ...
            return { ok: true, quoteId: q.id, message: `Job posted. Verified ${REGION} pros will reach out, usually within 1 business day.` };
          } catch (err) {
            ...
            return { ok: true, quoteId: null, message: `Got it — your job is in and verified ${REGION} pros will reach out within 1 business day.` };
          }
        },
      }),
    },
